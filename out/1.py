...
# ========== DeepSeek API 配置 ==========
DEEPSEEK_API_KEY = os.getenv("DEEPSEEK_API_KEY", "sk-b9397f787deb4685b61098f58cee9497")  # 替换成你的真实 Key
...
if __name__ == "__main__":
    # 可以直接运行单个函数进行调试
    # test_gender_bias("程序员")
    # test_paraphrase_robustness("今天天气怎么样", "今日天气如何")
    # test_irrelevant_noise()
